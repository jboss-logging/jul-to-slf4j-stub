...
Want to contribute to the jul-to-slf4j-stub? We try to make it easy, and all contributions, even the smaller ones,
...
All original contributions to jul-to-slf4j-stub are licensed under the
https://repository.jboss.org/licenses/mit.txt[MIT License], if another license is specified as governing the file or
directory being modified, such other license.
...
jul-to-slf4j-stub has a strictly enforced code style. Code formatting is done by the Eclipse code formatter, using the config files
